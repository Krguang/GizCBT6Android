...
public class DeviceDataActivity extends GosControlModuleBaseActivity {
    ...
    Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            DeviceDataActivity.handler_key key = DeviceDataActivity.handler_key.values()[msg.what];
            switch (key) {
                case UPDATE_UI:
                    updateUI();
                    break;
    ...
    private void toastDeviceDisconnectAndExit() {
        Toast.makeText(DeviceDataActivity.this, "连接已断开", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    protected void didUpdateNetStatus(GizWifiDevice device, GizWifiDeviceNetStatus netStatus) {
        ...
        if (netStatus == GizWifiDeviceNetStatus.GizDeviceControlled) {
            ...
            mHandler.sendEmptyMessage(DeviceDataActivity.handler_key.DISCONNECT.ordinal());
        }
    }
    ...
    protected void didReceiveData(GizWifiErrorCode result, GizWifiDevice device,
        ...
        if (result == GizWifiErrorCode.GIZ_SDK_SUCCESS && dataMap.get("data") != null) {
            ...
            mHandler.sendEmptyMessage(DeviceDataActivity.handler_key.UPDATE_UI.ordinal());
        }
    }
}
